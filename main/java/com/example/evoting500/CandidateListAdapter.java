...
public class CandidateListAdapter extends RecyclerView.Adapter<CandidateListViewHolder> {
    private Context context;
    private List<CandidatesData> dataList;
    public CandidateListAdapter(Context context, List<CandidatesData> dataList) {
    ...
    public CandidateListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CandidateListViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull CandidateListViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, VoteCandidate.class);
...
class CandidateListViewHolder extends RecyclerView.ViewHolder{
    ImageView recImage;
    TextView recHead, recName;
    CardView recCard;
    public CandidateListViewHolder(@NonNull View itemView) {
        super(itemView);
